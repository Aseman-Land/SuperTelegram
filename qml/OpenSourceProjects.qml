...
Rectangle {
    ...
    ListView {
        ...
        Component.onCompleted: {
            ...
            model.append({"title": "HyperBus", "license": "GNU GPL v3", "link": "https://github.com/Aseman-Land/hyperbus", "description": "HyperBus is a set of tools to make connections between your Qt programs. HyperBus is an IPC (Inter Process Communication) system like DBus and Corba systems."})
